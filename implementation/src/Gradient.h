...
__host__ __device__ inline float3 gradientCD(Volume& volume, float3& p)
{
	...
	{
		{ getVolumeIntensity(volume,(p + GRAD_DELTA_X)), getVolumeIntensity(volume,(p - GRAD_DELTA_X)) },
		{ getVolumeIntensity(volume,(p + GRAD_DELTA_Y)), getVolumeIntensity(volume,(p - GRAD_DELTA_Y)) },
		{ getVolumeIntensity(volume,(p + GRAD_DELTA_Z)), getVolumeIntensity(volume,(p - GRAD_DELTA_Z)) }
	};
